...
namespace Xunit.Sdk
{
    ...
    static class SerializationHelper
    {
        ...
        public static string GetTypeNameForSerialization(Type type)
        {
            ...
            {
                // Do this check in here so it's cached
                ...
                var assemblyName = typeToMap.GetAssembly()
                                       .FullName.Split(',')[0];
                ...
                if (typeToMap.GetAssembly()
                        .GetCustomAttributes()
                        .FirstOrDefault(a => a != null && a.GetType()
                                                           .FullName == "Xunit.Sdk.PlatformSpecificAssemblyAttribute") != null)
